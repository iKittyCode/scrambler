...
var posit = new Array();
function initbrd() {
  posit = new Array(1, 1, 1, 1, 2, 2, 2, 2, 5, 5, 5, 5, 4, 4, 4, 4, 3, 3, 3, 3, 0, 0, 0, 0);
}
initbrd();
var seq = new Array();
function solved() {
...
/*
  function mix(){
      initbrd();
      for(var i=0;i<500;i++){
          var f=Math.floor(randInt(3)+3) + 16*Math.floor(randomSource.random()*3);
          domove(f);
      }
  }
  */
...
var piece = new Array(15, 16, 16, 21, 21, 15, 13, 9, 9, 17, 17, 13, 14, 20, 20, 4, 4, 14, 12, 5, 5, 8, 8, 12, 3, 23, 23, 18, 18, 3, 1, 19, 19, 11, 11, 1, 2, 6, 6, 22, 22, 2, 0, 10, 10, 7, 7, 0);
var adj = new Array();
adj[0] = new Array();
adj[1] = new Array();
adj[2] = new Array();
...
function solve() {
  ...
  for (var d = 0; d < 7; d++) {
    ...
    ps[d] = p;
    if (posit[piece[a]] === posit[piece[42]] || posit[piece[a]] === opp[posit[piece[42]]]) tws[d] = 0;else if (posit[piece[a + 2]] === posit[piece[42]] || posit[piece[a + 2]] === opp[posit[piece[42]]]) tws[d] = 1;else tws[d] = 2;
    a += 6;
  }
